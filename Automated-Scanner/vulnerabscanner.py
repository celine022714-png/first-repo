...
def analyze_port_findings(port: int, banner: str) -> list[str]:
    ...
    if port == 21:
        ...
        issues.append("SMTP exposed; ensure it’s not an open relay.")
    elif port == 80:
        ...
        issues.append("DNS exposed; ensure it’s not an open resolver.")
...
def main():
    # 🔧 CHANGE THESE TWO VALUES TO WHATEVER YOU WANT TO SCAN
